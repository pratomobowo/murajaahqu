...
interface NavigationProps {
  activeTab: 'study' | 'quiz' | 'dalil';
  onTabChange: (tab: 'study' | 'quiz' | 'dalil') => void;
}
        ...
        <div className="grid grid-cols-3 h-16">
          <button
            ...
            className={`flex flex-col items-center justify-center w-full h-full transition-colors ${
              activeTab === 'study' ? 'text-primary-600' : 'text-slate-400 hover:text-slate-600'
            }`}
          >
            ...
            <span className="text-xs font-medium">List Surat</span>
          </button>
          
          <button
            onClick={() => onTabChange('dalil')}
            className={`flex flex-col items-center justify-center w-full h-full transition-colors ${
              activeTab === 'dalil' ? 'text-primary-600' : 'text-slate-400 hover:text-slate-600'
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center w-full h-full transition-colors ${
              activeTab === 'quiz' ? 'text-primary-600' : 'text-slate-400 hover:text-slate-600'
            }`}
          >
            ...
            <span className="text-xs font-medium">Murojaah</span>
          </button>
        </div>
      </div>
    </nav>
